                            ...
                            <tr>
                                ...
                                <td><?php 
                                    ...
                                    <?php 
                                        ...
                                        if ($v["votacaoId"] == $registro["id"]) {
                                        echo $v["candidato"] . " = " . $v["votos"] . "<br>";
                                        $totalVotos +=  $v["votos"];
                                    }
                                    ?>
                                    <?php endforeach; 
                                ...
                                <td><?php echo ($registro["isVotacaoAberta"] == 0) ? "Não" : "Sim"; ?></td>
                                
                                <td class="table-action">
                                    <a href="<?php echo base_url(); ?>/concilio-votacao-opcao/?votacaoId=<?php echo $registro["id"]; ?>" title="editar" class="btn"><i class="align-middle fas fa-align-justify"></i></a>
                                    <a href="<?php echo base_url(); ?>/<?php echo $route; ?>/<?php echo $registro["id"]; ?>" title="editar" class="btn"><i class="align-middle fas fa-fw fa-fw fa-pen"></i></a>
