...
<h2 class="text-center">Cadastro de Clérigos</h2>
        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="mb-3 col-lg-3 col-md-4 col-sm-12">
                    ...
                    <select class="form-control select2" data-bs-toggle="select2" width="fit" name="tipoClerigoId" id="tipoClerigoId" required="required">
                ...
                <div class="mb-3 col-3">
                    ...
                    <input class="form-control " id="dataConsagracao" name="dataConsagracao" maxlength="" value="<?php echo (isset($entidade) && isset($entidade["dataConsagracao"])) ? date("d/m/Y", strtotime($entidade["dataConsagracao"])) : ""; ?>" type="date" placeholder="">
                </div>

                <div class="mb-3 col-3">
                    <label for="dataOrdenacao">Data da Ordenação</label>
                    <input class="form-control " id="dataOrdenacao" name="dataOrdenacao" maxlength="" value="<?php echo (isset($entidade) && isset($entidade["dataOrdenacao"])) ? date("d/m/Y", strtotime($entidade["dataOrdenacao"])) : ""; ?>" type="date" placeholder="">
                </div>
                ...
                <div class="mb-3 col-3">
                    ...
                    <input class="form-control " id="dataNascimento" name="dataNascimento" maxlength="" value="<?php echo (isset($entidade) && isset($entidade["dataNascimento"])) ? date("d/m/Y", strtotime($entidade["dataNascimento"])) : ""; ?>" type="date" placeholder="" required="required">
                </div>
                ...
                <div class="mb-3  col-lg-3 col-md-3 col-sm-12">
                    ...
                    <select class="form-control select2" data-bs-toggle="select2" width="fit" name="estadoCivil" id="estadoCivil">
                        <option value="" disabled selected>Selecione</option>
        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="mb-3 col-3">
                    ...
                    <input class="form-control " id="dataEmissaoRg" name="dataEmissaoRg" maxlength="" value="<?php echo (isset($entidade) && isset($entidade["dataEmissaoRg"])) ? date("d/m/Y", strtotime($entidade["dataEmissaoRg"])) : ""; ?>" type="date" placeholder="">
                </div>
                ...
                <div class="mb-3 col-3">
                    ...
                    <input class="form-control " id="dataEmissaoCtps" name="dataEmissaoCtps" maxlength="" value="<?php echo (isset($entidade) && isset($entidade["dataEmissaoCtps"])) ? date("d/m/Y", strtotime($entidade["dataEmissaoCtps"])) : ""; ?>" type="date" placeholder="">
                </div>
