...
<h2 class="text-center">Cadastro de Aspirantes</h2>

<form method="POST" action="<?php echo base_url(); ?>/aspirante">
    <div class="card">
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="mb-3 col-lg-6 col-md-6 col-sm-12">
                    ...
                    <input class="form-control cpf" id="cpf" name="cpf" maxlength="200" value="<?php echo (isset($entidade)) ? $entidade["cpf"] : ""; ?>" type="text" placeholder="" required="required">
                </div>
                ...
                <div class="mb-3 col-lg-6 col-md-6 col-sm-12">
                    ...
                    <input class="form-control " required id="email" name="email" maxlength="200" value="<?php echo (isset($entidade)) ? $entidade["email"] : ""; ?>" type="email" placeholder="">
                </div>
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="mb-3 col-lg-6 col-md-6 col-sm-12">
                    <label for="igrejaId">Igreja/Congregação*</label>
                    <select class="form-control select2" data-bs-toggle="select2" width="fit" name="igrejaId" id="igrejaId" required="required">
                        <option value="" disabled selected>Selecione</option>
                        <?php foreach ($Instituicao as $item) : ?>
                            <option value="<?php echo $item["id"]; ?>" <?php echo (isset($entidade) and $item["id"] == $entidade["igrejaId"]) ? 'selected="selected"' : ""; ?>><?php echo $item["nome"]; ?> (<?php echo ($item["tipoInstituicaoId"] == 1) ? "Igreja" : "Congregação";?>) </option>
                        <?php endforeach; ?>
                    </select>
                </div>
    ...
    <div class="mb-3 col-lg-12 col-md-12 col-sm-12 text-center">
        ...
        <button class="btn btn-lg btn-primary mb-3 mt-3" type="submit" onclick="return validaFormulario()" >
            Salvar Cadastro
        </button>
