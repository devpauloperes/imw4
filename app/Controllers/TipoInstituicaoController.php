...
class TipoInstituicaoController extends BaseController
{

    private $route = 'tipo-instituicao';
    private $titlePage = 'Tipos de Instituições';
    private $dirView = 'TipoInstituicao';
